<x-layouts>
    <!-- Hero Section -->
    <div class="bg-primary-50 py-12 md:py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="lg:grid lg:grid-cols-2 lg:gap-8 items-center">
                <div>
                    <h1 class="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
                        <span class="block">Your Crochet</span>
                        <span class="block text-primary-600">Journey Starts Here</span>
                    </h1>
                    <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                        Discover personalized crochet projects, step-by-step tutorials, and connect with a community of fellow crocheters.
                    </p>
                    <div class="mt-8 sm:flex">
                        <div class="rounded-md shadow">
                            <a href="/tutorial" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-primary-600 hover:bg-primary-700 md:py-4 md:text-lg md:px-10">
                                Get Started
                            </a>
                        </div>
                        <div class="mt-3 sm:mt-0 sm:ml-3">
                            <a href="/tutorial" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-primary-700 bg-primary-100 hover:bg-primary-200 md:py-4 md:text-lg md:px-10">
                                Explore Tutorials
                            </a>
                        </div>
                    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="lg:text-center">
                ...
                <p class="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
                    From beginner-friendly tutorials to advanced projects, we've got you covered.
                </p>
            </div>
                ...
                <div class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                    <div class="relative">
                        ...
                        <div class="ml-16">
                            ...
                            <p class="mt-2 text-base text-gray-500">
                                Take a quick quiz to determine your skill level and get personalized recommendations.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="ml-16">
                            ...
                            <p class="mt-2 text-base text-gray-500">
                                Get personalized project suggestions based on your skill level and preferences.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="ml-16">
                            ...
                            <p class="mt-2 text-base text-gray-500">
                                Step-by-step tutorials with clear images and instructions for all skill levels.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="ml-16">
                            ...
                            <p class="mt-2 text-base text-gray-500">
                                Rate projects and tutorials to help us improve and recommend better content.
                            </p>
                        </div>
                    </div>
                </div>
